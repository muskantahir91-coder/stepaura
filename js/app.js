  ...
  <nav class="navbar">
    <div class="nav-inner">
      <a href="index.html" class="brand" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
        ...
        <span style="font-family:'Playfair Display',serif;font-size:21px;font-weight:800;letter-spacing:-0.01em;color:#ffffff;">Step<span style="color:#8b5cf6;">Aura</span></span>
      </a>
